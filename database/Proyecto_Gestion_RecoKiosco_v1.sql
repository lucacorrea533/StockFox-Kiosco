...
DROP DATABASE IF EXISTS StockFox; -- Si la BBDD ya existe, se elimina para poder recrearla

-- Crea la base de datos con soporte completo para caracteres especiales
CREATE DATABASE StockFox
...
CREATE TABLE ALUMNOS (
    ...
    nombre VARCHAR(50) NOT NULL,
    apellido VARCHAR(50) NOT NULL,
    curso VARCHAR(50) NOT NULL, -- Curso al que pertenece el alumno
